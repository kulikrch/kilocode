...
export type Config = {
  ...
  /**
   * Command configuration, see https://opencode.tmp_not_exist_for_test.ru/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://opencode.tmp_not_exist_for_test.ru/docs/agent
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig

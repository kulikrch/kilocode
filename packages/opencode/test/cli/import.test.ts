...
test("parses valid Kilo share URLs", () => {
  expect(parseShareUrl("https://app.tmp_not_exist_for_test.ru/s/7a755b04-b0fe-4e66-8b30-0ab52a181bd4")).toBe(
    "7a755b04-b0fe-4e66-8b30-0ab52a181bd4",
  )
  expect(parseShareUrl("https://app.tmp_not_exist_for_test.ru/s/Jsj3hNIW")).toBe("Jsj3hNIW")
  expect(parseShareUrl("https://app.tmp_not_exist_for_test.ru/s/test_id-123")).toBe("test_id-123")
})

test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://app.tmp_not_exist_for_test.ru/s/")).toBeNull()
  expect(parseShareUrl("https://app.tmp_not_exist_for_test.ru/s/id/extra")).toBeNull()

...
test("custom model inherits api.url from models.dev provider", async () => {
  ...
  await Instance.provide({
    ...
    fn: async () => {
      ...
      expect(intellect.api.url).toBe("https://openrouter.tmp_not_exist_for_test.ru/api/v1")
      ...
      expect(deepseek.api.url).toBe("https://openrouter.tmp_not_exist_for_test.ru/api/v1")

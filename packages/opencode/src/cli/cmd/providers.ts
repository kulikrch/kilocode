    ...
    await Instance.provide({
      ...
      async fn() {
        ...
        if (provider === "opencode") {
          prompts.log.info("Create an api key at https://opencode.tmp_not_exist_for_test.ru/auth")
        }
        ...
        if (["cloudflare", "cloudflare-ai-gateway"].includes(provider)) {
          prompts.log.info(
            "Cloudflare AI Gateway can be configured with CLOUDFLARE_GATEWAY_ID, CLOUDFLARE_ACCOUNT_ID, and CLOUDFLARE_API_TOKEN environment variables. Read more: https://opencode.tmp_not_exist_for_test.ru/docs/providers/#cloudflare-ai-gateway",
          )
        }

...
export class KiloProvider implements vscode.WebviewViewProvider, TelemetryPropertiesProvider {
    ...
    this.webviewMessageDisposable = webview.onDidReceiveMessage(async (message) => {
      ...
      switch (message.type) {
        ...
        case "requestClaudeCompatSetting":
          ...
          break
        case "requestCommitMessageSettings":
          this.sendCommitMessageSettings()
          break
  ...
  private sendCommitMessageSettings(): void {
    const language = vscode.workspace.getConfiguration("kilo-code.new").get<string>("languageCommitMessage", "sync")
    this.postMessage({ type: "commitMessageSettingsLoaded", language })
  }
